...
const Categories = () => {
  ...
  const [deactivateSubmitting, setDeactivateSubmitting] =
    useState(false);

  const [activateSubmitting, setActivateSubmitting] =
    useState(false);
  ...
  const confirmDeactivate = async () => {
    ...
    try {
      ...
      await api.delete(
        `/categories/${categoryToDeactivate._id}`,
      );
